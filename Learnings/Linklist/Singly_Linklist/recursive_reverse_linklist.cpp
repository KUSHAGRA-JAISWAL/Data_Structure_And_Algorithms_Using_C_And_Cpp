/**
 * @file recursive_reverse_linklist.cpp
 * @author KUSHAGRA-JAISWAL
 * @date 2023-01-21
 * @copyright Copyright (c) 2023
 */

/* Program to understand how to reverse the singly linklist recursivly Using C and Cpp. */
...
int main()
{
    ...
    node *revHead = reverseRecursive(head);
    // reversing the link list
