/**
 * @file deletion_dbly_linklist.cpp
 * @author KUSHAGRA-JAISWAL
 * @date 2023-01-21
 * @copyright Copyright (c) 2023
 */

/* Program to understand how to delete the element from doubly linklist Using C and Cpp. */
...
// function to delete the element at the beginning of link list
{
    node *todelete = head;
    head = head->next;
    head->prev = NULL;
...
// function to delete the element at the given position of link list
{
    if (pos == 1)
    {
        deleteAtHead(head);
